...
export const ManagerStateSchema = z.object({
  ...
  teamStatus: z.record(z.string(), z.object({
    agentId: z.string(),
    role: z.string(),
...
export class ManagerAgent implements QueenAgentCapabilities {
   ...
   */
  private async analyzeProject(state: ManagerState): Promise<Partial<ManagerState>> {
   ...
   */
  private async delegateTasks(state: ManagerState): Promise<Partial<ManagerState>> {
   ...
   */
  private async monitorProgress(state: ManagerState): Promise<Partial<ManagerState>> {
   ...
   */
  private async reviewWork(state: ManagerState): Promise<Partial<ManagerState>> {
    return {
   ...
   */
  private selectBestAgent(task: any, teamStatus: any): string {
  ...
  async analyzeTask(task: Task): Promise<{ agentCount: number; agentTypes: string[] }> {
