...
beforeEach(() => {
  global.Image = vi.fn(() => createMockImage()) as unknown as new () => HTMLImageElement;
});
...
describe("Avatar Components", () => {
  ...
  describe("AvatarImage", () => {
    it("should render image with proper attributes when loaded", () => {
      render(<BasicAvatar src="https://example.com/avatar.jpg" alt="John Doe" />);
  ...
  describe("AvatarFallback", () => {
    ...
    it("should display when image fails to load", async () => {
      ...
      global.Image = vi.fn(() => failingImage) as unknown as new () => HTMLImageElement;
  ...
  describe("Accessibility", () => {
    ...
    it("should provide fallback text as accessible content when image is missing", () => {
      render(
        <Avatar data-testid="avatar">
          <AvatarImage data-testid="avatar-image" />
          <AvatarFallback data-testid="avatar-fallback">John Smith</AvatarFallback>
        </Avatar>
      );
