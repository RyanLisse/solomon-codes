...
export function setCorrelationId(correlationId: string): void {
	...
	globalThis.__correlationId = correlationId;
}
...
export function clearCorrelationId(): void {
	delete globalThis.__correlationId;
}
...
export function createCorrelationMetadata(
	...
	const correlationId = getCorrelationId() || globalThis.__correlationId;
...
export function extractCorrelationId(
	...
	if (sources.metadata?.correlationId) {
		return sources.metadata.correlationId;
	}
