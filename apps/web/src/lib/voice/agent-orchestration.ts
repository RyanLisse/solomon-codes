...
export class AgentRouter {
	...
	private agents: Map<AgentType, LettaVoiceAgent> = new Map();
	private defaultAgent: AgentType = AgentType.VOICE;
...
export class AgentOrchestrationService {
	...
	async processVoiceMessage(
		...
		context.metadata.messageCount = (context.metadata.messageCount || 0) + 1;
