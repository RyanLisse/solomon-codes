...
describe("TaskForm", () => {
	let mockCreateTask: { mutateAsync: ReturnType<typeof vi.fn>, isPending: boolean };
	...
	beforeEach(async () => {
		...
		const taskModule = vi.mocked(await import("@/hooks/use-tasks"));
		mockCreateTask = taskModule.useCreateTask();
